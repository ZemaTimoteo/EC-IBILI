...
clear initialiDiago aux testnumber
...
%                                 Multiple_Zscores{1,pp}{aux,ii}(conectIndex); % add significative values to matrix of condition1
        Z_scoreAllMat{aux,ii}              = Z_scoreAllMat{aux,ii} + Multiple_Zscores{1,pp}{aux,ii}; % add z_score values to matrix of condition1
        conectIndex                        = find(BinarySignif{1,pp}{aux,ii}>0);
        SignifBinary{aux,ii}(conectIndex)  = SignifBinary{aux,ii}(conectIndex) + ...
