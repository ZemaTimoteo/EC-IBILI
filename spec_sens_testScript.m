...
%% ... Inicializacao ...
pointsVect  =  200; %[10 20 30 40 60 80 100 160 200] + 50; % 60 80 100 160 200]+50; % + 50 para excluir os primeiro 50 pontos afectados pela HRF [3000]; % [10 20 30 40 60 80 100 160 200]; % [40 80]; % [40:5:80]; % 
blocksVect  = 40;% [ 2  4 8 13 15 17  25  30  40]; %  [ 20]; % [ 2  4  8 13 15 17  25  30  40]; % [4 25]; % 40; %
